...
namespace HR_LIB.HR
{
    public class Attendance
    {
        ...
        public static Guid add(Guid userAccountID, Guid UserAccounts_Id, DateTime timestampIn, DateTime timestampOut,
            Guid? Clients_Id, Guid? Workshifts_Id, DateTime? effectiveTimestampIn, DateTime? effectiveTimestampOut, string notes)
        {
        ...
        {
            return Util.getFirstRow(get(sqlConnection, id, null, null, null, null, null, null, null));
        }
        public static DataRow get(Guid id)
        {
            DataRow row;
            using (SqlConnection sqlConnection = new SqlConnection(DBConnection.ConnectionString))
                row = Util.getFirstRow(get(sqlConnection, id, null, null, null, null, null, null, null));
            return row;
        }
        public static DataTable get(Guid? id, Guid? UserAccounts_Id, int? dayOfWeek, DateTime? startDate, DateTime? endDate, TimeSpan? startTime, TimeSpan? endTime, string notes)
        {
            DataTable datatable;
            using (SqlConnection sqlConnection = new SqlConnection(DBConnection.ConnectionString))
                datatable = get(sqlConnection, id, UserAccounts_Id, dayOfWeek, startDate, endDate, startTime, endTime, notes);
            return datatable;
        }
        public static DataTable get(SqlConnection sqlConnection, Guid? id, Guid? UserAccounts_Id, int? dayOfWeek, DateTime? startDate, DateTime? endDate, TimeSpan? startTime, TimeSpan? endTime, string notes)
        {
            SqlQueryResult result = DBConnection.query(
                sqlConnection,
