...
namespace HR_Desktop.Admin
{
    public partial class UserAccounts_Profile_Form : Form
    {
        ...
        {
            Util.populateDataGridView(dgvWorkshifts, Workshift.get(false, null, null, null, _UserAccounts_Id, null, null, (int)Util.getDayOfWeekFromActiveRadioButtonTag(flpWorkshifts), null, null, null, null));
        }
